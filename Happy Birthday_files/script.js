...
// Continuous Music Player (plays non-stop, no close button)
function playMusic() {
    var audio = $('.song')[0];
    if (audio) {
        audio.loop = true;
...
// Ensure audio plays and stays playing on user interactions
...
// Try to play immediately when page is ready
